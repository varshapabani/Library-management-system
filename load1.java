...
public class load1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Load..");
        setMinimumSize(new java.awt.Dimension(1390, 700));
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/project/photos/load.png"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1470, 710));
